...
#		$config_string = str_replace("PASSWORD2",$poolpass2,$config_string);
        ...
        ********************************/
        if (preg_match("/bminer/",$miner)){ 
                ...
                $pools=" -uri cuckaroo29://$proxywallet:$poolpass1@$proxypool1 ";

                if($proxypool2 != "") {
                        $pools .= " -uri cuckaroo29://$proxywallet:$poolpass1@$proxypool1, cuckaroo29://$proxywallet:$poolpass2@$proxypool2 ";
                }
        }
